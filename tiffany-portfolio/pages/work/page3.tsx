...
export default function PageThree({pageThreeData,fontAPIData}:PageThreeProps) {
  ...
  return (
    <div className='flex flex-col'>
      <Head>
        <title>TIFFANYCFY / WORK / {pageThreeMetadata?.title}</title>
      </Head>
      ...
      <section className='relative lg:h-[90vh] sm:h-[40vh] md:h-[50vh] sm:mb-10'>
            ...
            <div className='absolute top-5 left-0 flex flex-row items-center justify-center w-full h-full'>
              <img alt='' src={pageThreeMetadata.nextPagePic?.fields.file.url} className='md:w-1/2 h-[80vh] sm:w-1/2 lg:max-w-[520px]  sm:h-5/6 md:h-5/6'/>
              <div
