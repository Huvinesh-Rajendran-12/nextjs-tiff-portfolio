...
export default function PageOne() {
  ...
  const pageOneMetadata = usePagesStore((state) => state.pagesData ? state.pagesData[0].metadata : undefined)
  const pageTwoPic = usePagesStore((state) => state.pagesData ? state.pagesData[1].metadata.pic_1 : undefined)
    ...
    <div className="flex flex-col">
      ...
      <section className='flex flex-row justify-center mx-20'>
        <div className='py-20 space-y-10'>
          ...
          <div className='lg:w-1/2 w-full'>
            <img alt='' src={pageOneMetadata?.pic_2.imgix_url}/>
            <img alt='' src={pageOneMetadata?.pic_3.imgix_url}/>
          </div>
          <video src={pageOneMetadata?.vid_1}></video>
          <img
            alt=""
            src={
            ...
            />
          <div className='lg:w-1/2 w-full'>
            <img alt='' src={pageOneMetadata?.pic_5.imgix_url}/>
            <img alt='' src={pageOneMetadata?.pic_6.imgix_url}/>
          </div>
        </div>
      </section>
      <section className='relative h-[90vh]'>
            ...
            <div className='absolute top-10 left-0 flex flex-row justify-center w-full h-full'>
              <img alt='' src={pageTwoPic?.imgix_url} className='md:w-1/3 h-[80vh] sm:w-1/2  max-h-200px' />
            </div>
      </section>
    </div>
  );
