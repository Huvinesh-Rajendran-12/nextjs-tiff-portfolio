...
export default function PageTwo({pageTwoData, fontAPIData}:PageOneProps) {
  ...
  return (
    <div className='flex flex-col'>
       <Head>
        <title>TIFFANYCFY / WORK / {pageTwoMetadata?.title}</title>
      </Head>
          ...
          <div className='py-20 space-y-10'>
            ...
            <div className='flex sm:flex-col md:flex-row'>
              <div className='md:w-1/2 w-full'>
                <img alt='' src={pageTwoMetadata.pic2?.fields.file.url} className='h-full max-h-[550px] rounded-md'/>
              </div>
              <div className='md:w-1/2 w-full md:pl-4 sm:mt-10 md:mt-0'>
                <img alt='' src={pageTwoMetadata.pic3?.fields.file.url} className='h-full max-h-[550px] rounded-md'/>
              </div>
            </div>
            ...
            <div className='flex sm:flex-col md:flex-row'>
              <div className='md:w-1/2 w-full'>
                <img alt='' src={pageTwoMetadata.pic5?.fields.file.url} className='h-full max-h-[550px] rounded-md'/>
              </div>
              <div className='md:w-1/2 w-full md:pl-4 sm:mt-10 md:mt-0'>
                <img alt='' src={pageTwoMetadata.pic6?.fields.file.url} className='h-full max-h-[550px] rounded-md'/>
              </div>
            </div>
        </div>
      </section>
      <section className='relative lg:h-[90vh] sm:h-[40vh] md:h-[50vh] sm:mb-10'>
            ...
            <div className='absolute top-5 left-0 flex flex-row items-center justify-center w-full h-full'>
              <img alt='' src={pageTwoMetadata.nextPagePic?.fields.file.url} className='md:w-1/2 h-[80vh] sm:w-1/2 lg:max-w-[520px]  sm:h-5/6 md:h-5/6'/>
              <div
